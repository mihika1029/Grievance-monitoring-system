...
<body>
    ...
    <hr>
      ...
      <br />
      <asp:TextBox ID="name" runat="server" Width="343px" required="true"></asp:TextBox>
      <label for="email"><b>
        <br />
        Email</b></label>
      <br />
      <asp:TextBox ID="email" runat="server" Width="335px" required="true"></asp:TextBox>
      <br />
      <label for="psw"><b>Password</b></label>
      <br />
      <asp:TextBox ID="pwd" runat="server" required="true" Width="331px"></asp:TextBox>
      <br />
&nbsp;<label for="designation"><b>Designation<br />
      <asp:TextBox ID="addr" runat="server" Width="374px" required="true"></asp:TextBox>
      <br />
      </b></label>&nbsp;<label for="number"><b>Contact number</b></label>
      <label>
        <br />
      &nbsp;<asp:TextBox ID="cn" runat="server" Width="373px" required="true"></asp:TextBox>
      <br />
